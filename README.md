...
<p>
  ...
  <img alt="Python" src="https://img.shields.io/badge/python-3.14%2B-blue">
...
需要 Linux、[Python 3.14](https://www.python.org/) 和 [uv](https://docs.astral.sh/uv/)。
...
想清理清单之外的路径？在项目根目录放一个 `custom.json`：
